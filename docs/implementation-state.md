...
Phase 0 is documentation, tests and local/CI tooling only. It does not change product behavior or schema. Rollback is therefore a normal Git revert of Phase 0 commits or resetting `feat/bardo-unified-experience` to the frozen SHA. No D1/R2 rollback is required.
