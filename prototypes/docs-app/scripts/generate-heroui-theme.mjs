...
// https://heroui.com/en/themes?lightness=0.5774&chroma=0.2091&hue=273.85&base=0.01&radius=small
// Omitted query values intentionally use HeroUI defaults: fontFamily=inter, formRadius=large.
