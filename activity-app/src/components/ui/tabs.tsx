...
function Tabs({
  ...
  const tabValue = value !== undefined ? value : selectedKey
  const tabDefValue = defaultValue !== undefined ? defaultValue : defaultSelectedKey
...
function TabsTrigger({
  ...
  const triggerValue = value !== undefined ? value : id
  return (
...
function TabsContent({
  ...
  const contentValue = value !== undefined ? value : id
  return (
...
export { Tabs, TabsList, TabsTrigger, TabsContent, Tab, tabsListVariants }
