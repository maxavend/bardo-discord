...
export function PlannerUpcomingBanner({
  ...
  return (
    <div className="w-full max-w-4xl mx-auto mb-2 animate-in fade-in slide-in-from-top-2 duration-300">
      <div className="container-surface flex items-center justify-between gap-3 p-3 sm:py-2.5 sm:px-4 rounded-xl bg-accent/10 border border-accent/30 text-foreground">
