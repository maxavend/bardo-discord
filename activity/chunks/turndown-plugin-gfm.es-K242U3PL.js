import"./chunk-EPXOE4VI.js";var u=/highlight-(?:text|source)-([a-z0-9]+)/;function s(e){e.addRule("highlightedCodeBlock",{filter:function(t){var n=t.firstChild;return t.nodeName==="DIV"&&u.test(t.className)&&n&&n.nodeName==="PRE"},replacement:function(t,n,r){var i=n.className||"",l=(i.match(u)||[null,""])[1];return`
